...
const Alphabet_1 = require("../../src/services/Alphabet");
describe('Tests AlphabetService', () => {
    it('should return 3 coincidences', () => {
        ...
        chai_1.expect(amount).to.equal(3);
    });
    it('should return 4 coincidences', () => {
        ...
        const alphabeteService = new Alphabet_1.default(matrix);
        const amount = alphabeteService.solve(word);
        chai_1.expect(amount).to.equal(4);
    });
    it('should return 8 coincidences', () => {
        ...
        const alphabeteService = new Alphabet_1.default(matrix);
        const amount = alphabeteService.solve(word);
        chai_1.expect(amount).to.equal(8);
    });
    it('should return 3 coincidences', () => {
        const matrix = [
            ['O', 'X'],
    ...
    it('should return coincidences greater than 1', () => {
        ...
        const alphabeteService = new Alphabet_1.default(matrix);
        const amount = alphabeteService.solve(word);
        chai_1.expect(amount).to.greaterThanOrEqual(1);
    });
